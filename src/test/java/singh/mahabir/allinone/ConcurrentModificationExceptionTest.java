...
public class ConcurrentModificationExceptionTest {
     ...
     * we can use ideas of functional programming to achieve the same results
     */
    @Test
    ...
    public void safeRemovingUsingJava8_Stream() {
        ...
        final List<String> collected = integers.stream().filter(i -> i != 2).map(Object::toString).collect(Collectors.toList());
