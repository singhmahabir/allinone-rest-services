 ...
 * It contains
 * <ul>
 * <li>reverse the linked list using stack and variable</li>
 * <li>find a loop in linked list hashSet and stack and Floyd’s Cycle-Finding
 * Algorithm</li>
 * <li>Find the median the linked list</li>
 * </ul>
 * 
