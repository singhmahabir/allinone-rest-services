...
public class ProcessingThreadWithAtomic implements Runnable {
	...
	private void processSomething(int i) {
		// processing some job
		System.out
				.println(Thread.currentThread().getName() + " entry with iteration " + i + " with value " + getCount());
		try {
		...
		System.out.println(
				Thread.currentThread().getName() + " exisintg  with iteration " + i + " with value " + getCount());
	}
