...
/*
 * @Validated is required to activate the validation in controller class Spatially for @PathVariable and @RequestParam
 * and use @Valid when @Validated is not available
 */
@Validated
@Slf4j
