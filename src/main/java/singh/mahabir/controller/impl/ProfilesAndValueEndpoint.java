...
public class ProfilesAndValueEndpoint {
     ...
     */
    @Value("${systemValue:default-syatem}")
     ...
     * properties file, so in the following example the array values would be
     * <code> [“A”, “B”, “C”]: </code> catch in
     * <code> private String[] valuesArray; </code>
     */
    @Value("${listOfValues}")
     ...
     */
    @Value("#{systemProperties['unknown'] ?: 'Not Null value'}")
